...
interface IconProps {
  name: 'home' | 'search' | 'plus' | 'heart' | 'user' | 'camera' | 'send' | 'comment' | 'sparkles' | 'bell' | 'eye' | 'eye-off' | 'shield';
  size?: number;
  className?: string;
  fill?: string;
}
...
export const Icon: React.FC<IconProps> = ({ name, size = 24, className = '', fill = 'none' }) => {
  const paths: Record<string, React.ReactNode> = {
    ...
    plus: <><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M12 8v8"/><path d="M8 12h8"/></>,
